...
const gerarFilmes = (id_filme)=>{
    ...
    var url = `https://api.themoviedb.org/3/tv/${id_filme}?api_key=0e69076d20c5ace4ad954de6e2df2c18&language=pt-BR`;
            ...
            <div class="desc_filme" id="desc_filme_id">
                <div class="nome_filme" id="nome_filme_id">
                    <h1 class="nome" dir="auto">
                        ...
                        <span class="tag_release_date">(${resposta.first_air_date.substr(0, 4)})</span>
                    </h1>
                </div>
                <div class="facts">
                    <div class="infos">
                        ...
                        ${resposta.first_air_date.split("-").reverse().join("-")} |
                        </span>
...
const getSimilar = (id_filme)=>{
    var url = `https://api.themoviedb.org/3/tv/${id_filme}/similar?api_key=0e69076d20c5ace4ad954de6e2df2c18&language=pt-BR&page=1`;
...
const pegarTrailer = (id_filme, br) =>{
    ...
    if(br){
        url = `http://api.themoviedb.org/3/tv/${id_filme}/videos?language=pt-BR&api_key=0e69076d20c5ace4ad954de6e2df2c18`;
    }else{
        url = `http://api.themoviedb.org/3/tv/${id_filme}/videos?api_key=0e69076d20c5ace4ad954de6e2df2c18`;
    }
    console.log(url)
    $.getJSON(url, 
    function(data) {
